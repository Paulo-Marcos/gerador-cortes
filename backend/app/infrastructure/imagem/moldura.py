"""A moldura do canal colada na capa do YouTube: o trabalho de imagem (D-696).
...
Qual moldura cada corte merece é regra editorial e mora em
`domain/moldura_thumbnail`.
"""
