...
| RN | Regra | Onde mora | Origem |
|---|---|---|---|
| RN-14 | **Fire** (julgamento sobre o corte) é independente de `candidato_shorts` (aposta sobre um trecho). | `models.py` (`Corte.is_fire`, `Corte.candidato_shorts`) | D-502, D-713 |
